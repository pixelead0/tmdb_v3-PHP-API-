<?php
    ...
    echo '  <div class="panel panel-default">
                <div class="panel-body">
                    Now the <b>$collection</b> var got all the data, check the <a href="http://code.octal.es/php/tmdb-api/class-Collection.html">documentation</a> for the complete list of methods.<br><br>
